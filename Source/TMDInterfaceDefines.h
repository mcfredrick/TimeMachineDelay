...
const Colour TMDColour_1 = Colour(105, 105, 105);
const Colour TMDColour_2 = Colour(0, 0, 0).withAlpha(0.0f);
const Colour TMDColour_3 = Colour(0, 0, 0).withAlpha(0.3f);
const Colour TMDColour_4 = Colour(0, 0, 0).withAlpha(0.6f);
const Colour TMDColour_5 = Colour(105, 105, 105).withAlpha(0.3f);
const Colour TMDColour_6 = Colour(0, 0, 0).withAlpha(0.8f);
const Colour TMDColour_7 = Colour(125, 125, 125);
const Colour TMDColour_glow = Colours::skyblue;
